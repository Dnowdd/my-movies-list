...
function Search(){
    ...
    useEffect(() => {
        ...
        const query = queryParameters.get('name');
        ...
        fetch(`https://api.themoviedb.org/3/search/movie?query=${query.replace(' ','%20')}&include_adult=true&language=${lang()}&page=1`, options)
